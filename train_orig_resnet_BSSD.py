...
res_folder = 'results/BSS_distillation_res_18'
temperature = 3
gpu_num = 0
attack_size = 64
max_epoch = 20
...
teacher = torch.load("./results/teacher/cifar_resnet50_final.pth", map_location=lambda storage, loc: storage.cuda(0))
t_net = resnet50()
t_net.load_state_dict(teacher)
...
torch.save(s_net.state_dict(), PATH)